...
import { getHumanReadableRecurrenceString } from '@/utils/calendar'
...
export default function CalendarEventDialogContent({
  event,
}: DefaultCalendarEventProps): JSX.Element {
        ...
        {event?.organizer?.displayName && (
          <Box display='flex'>
            ...
            <Box ml={3}>
              ...
              <Typography variant='body2' fontSize={'0.95rem'}>
                Updated {dayjs(event.updated).fromNow()}
              </Typography>
            </Box>
          </Box>
        )}
